...
def load_dataset(data_dir):
    ...
    y_train_data = cv2.imread(os.path.join(data_dir, Y_TRAIN_FILE), cv2.IMREAD_GRAYSCALE)
    y_test_data = cv2.imread(os.path.join(data_dir, Y_TEST_FILE), cv2.IMREAD_GRAYSCALE)
