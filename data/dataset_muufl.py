...
"""
    ...
    Args:
        data_dir (str): The directory path where the dataset files are located.

    Returns:
        tuple: A tuple containing the following elements:
            - X_train (ndarray): The training samples.
            - y_train (ndarray): The corresponding training labels.
            - X_data (ndarray): The complete dataset.
...
def load_dataset(data_dir):
    ...
    # This code snippet is preparing the dataset for training.
    ...
    # The code snippet is creating the training samples and labels for the dataset.
    X = []
    y = []
    ...
    # The code snippet is creating a list `idx_train` that contains the indices of the training samples.
    idx_train = []
